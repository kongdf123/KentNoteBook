...
{
	internal static class VueDevelopmentServerMiddlewareCustom
	{
		...
		public static void Attach(
			...
			var logger = LoggerFinderCustom.GetOrCreateLogger(appBuilder, LogCategoryName);
		...
		private static async Task<int> StartCreateReactAppServerAsync(
			...
			var portNumber = TcpPortFinderCustom.FindAvailablePort();
			...
			var npmScriptRunner = new NpmScriptRunnerCustom(
				sourcePath, npmScriptName, null, envVars);
			npmScriptRunner.AttachToLogger(logger);

			using ( var stdErrReader = new EventedStreamStringReaderCustom(npmScriptRunner.StdErr) ) {
				try {
