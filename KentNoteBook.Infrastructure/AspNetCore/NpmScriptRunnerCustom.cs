...
{
	public class NpmScriptRunnerCustom
	{
		public EventedStreamReaderCustom StdOut { get; }
		public EventedStreamReaderCustom StdErr { get; }

		private static Regex AnsiColorRegex = new Regex("\x001b\\[[0-9;]*m", RegexOptions.None, TimeSpan.FromSeconds(1));

		public NpmScriptRunnerCustom(string workingDirectory, string scriptName, string arguments, IDictionary<string, string> envVars) {
			...
			StdOut = new EventedStreamReaderCustom(process.StandardOutput);
			StdErr = new EventedStreamReaderCustom(process.StandardError);
		}
